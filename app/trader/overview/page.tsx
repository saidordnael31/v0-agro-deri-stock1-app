          ...
          <Card className="bg-yellow-500/5 border-yellow-500/20">
            <CardContent className="p-4">
              <p className="text-sm text-yellow-200">
                <strong>Aviso:</strong> Rendimentos variam com o mercado. Sem garantias. Leia os fatores de risco antes
                de investir. Produtos derivativos envolvem risco de perda total.
              </p>
            </CardContent>
          </Card>
        </div>
